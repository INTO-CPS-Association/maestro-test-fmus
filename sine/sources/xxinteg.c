...
static XXDouble xx_q0 [0 + 1];
#endif

#ifdef RungeKutta4_METHOD
static XXDouble xx_q0 [0 + 1];
static XXDouble xx_q1 [0 + 1];
static XXDouble xx_q2 [0 + 1];
static XXDouble xx_q3 [0 + 1];
static XXDouble xx_q4 [0 + 1];
#endif
...
void XXRungeKutta2Initialize (void)
{
	...
	memset (xx_q0, '\0', (0 + 1) * sizeof (XXDouble));
}
...
void XXRungeKutta2Step (void)
{
	...
	if (0 > 0)
	{
		...
		memcpy (xx_q0, xx_s, 0 * sizeof (XXDouble));
...
void XXRungeKutta4Initialize (void)
{
	/* empty our static arrays */
	memset (xx_q0, '\0', (0 + 1) * sizeof (XXDouble));
	memset (xx_q1, '\0', (0 + 1) * sizeof (XXDouble));
	memset (xx_q2, '\0', (0 + 1) * sizeof (XXDouble));
	memset (xx_q3, '\0', (0 + 1) * sizeof (XXDouble));
	memset (xx_q4, '\0', (0 + 1) * sizeof (XXDouble));
}
...
void XXRungeKutta4Step (void)
{
	...
	if (0 > 0)
	{
		...
		XXCalculateDynamic ();
		memcpy (xx_q2, xx_R, 0 * sizeof (XXDouble));
		...
		XXCalculateDynamic ();
		memcpy (xx_q3, xx_R, 0 * sizeof (XXDouble));
		...
		xx_time = rktime + xx_step_size;
		XXCalculateDynamic ();
		memcpy (xx_q4, xx_R, 0 * sizeof (XXDouble));
